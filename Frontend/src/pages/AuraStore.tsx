...
const auraTiers = [
  ...
  { threshold: 100, label: 'Sprout', color: '#A3B18A', icon: '◐', description: 'AI-generated flashcards from repository content.', unlocked: true },
  { threshold: 250, label: 'Sapling', color: '#5C7A6B', icon: '◑', description: 'AI-generated practice exams based on class notes.', unlocked: true },
...
const cosmetics = [
  {
    ...
    items: [
      { name: 'Golden Quill', cost: 50, preview: '🖊', rarity: 'common', description: 'A handwritten badge for dedicated note-takers.' },
...
const premiumFeatures = [
  {
    ...
    desc: 'Auto-generated exams from your notes with proper notation.',
  },
  {
